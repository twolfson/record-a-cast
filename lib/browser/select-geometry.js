...
Mousetrap.bind('ctrl+down',  resizeBy.bind(null, {top:    -5}));
Mousetrap.bind('ctrl+left',  resizeBy.bind(null, {left:   +5}));
Mousetrap.bind('ctrl+right', resizeBy.bind(null, {left:   -5}));
Mousetrap.bind('alt+up',     resizeBy.bind(null, {bottom: -5}));
Mousetrap.bind('alt+down',   resizeBy.bind(null, {bottom: +5}));
Mousetrap.bind('alt+left',   resizeBy.bind(null, {right:  -5}));
