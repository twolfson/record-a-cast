...
Mousetrap.bind('ctrl+up',    resizeBy.bind(null, {bottom: -1}));
Mousetrap.bind('ctrl+down',  resizeBy.bind(null, {bottom: +1}));
Mousetrap.bind('ctrl+left',  resizeBy.bind(null, {right:  -1}));
Mousetrap.bind('ctrl+right', resizeBy.bind(null, {right:  +1}));
Mousetrap.bind('alt+up',     resizeBy.bind(null, {top:    +1}));
Mousetrap.bind('alt+down',   resizeBy.bind(null, {top:    -1}));
Mousetrap.bind('alt+left',   resizeBy.bind(null, {left:   +1}));
Mousetrap.bind('alt+right',  resizeBy.bind(null, {left:   -1}));
Mousetrap.bind('shift+ctrl+up',    resizeBy.bind(null, {bottom: -5}));
Mousetrap.bind('shift+ctrl+down',  resizeBy.bind(null, {bottom: +5}));
Mousetrap.bind('shift+ctrl+left',  resizeBy.bind(null, {right:  -5}));
Mousetrap.bind('shift+ctrl+right', resizeBy.bind(null, {right:  +5}));
Mousetrap.bind('shift+alt+up',     resizeBy.bind(null, {top:    +5}));
Mousetrap.bind('shift+alt+down',   resizeBy.bind(null, {top:    -5}));
Mousetrap.bind('shift+alt+left',   resizeBy.bind(null, {left:   +5}));
Mousetrap.bind('shift+alt+right',  resizeBy.bind(null, {left:   -5}));
