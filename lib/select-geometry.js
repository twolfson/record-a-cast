...
function selectGeometry(cb) {
  ...
  function handleDragMove(evt, data) {
    ...
    var newX = dragStartAbsolutePosition.x + absoluteDifference.x - mouseOffset.x;
    var newY = dragStartAbsolutePosition.y + absoluteDifference.y - mouseOffset.y;

    // Update our location
    console.log(dragStartBrowserPosition, absoluteDifference, newX, newY);
