...
function selectGeometry(cb) {
  ...
  function handleDragMove(evt, data) {
    ...
    var moveVector = data;
    var initialX = dragStartBrowserPosition[0];
    var newX = initialX + moveVector.x;
    var initialY = dragStartBrowserPosition[1];
    var newY = initialY + moveVector.y;
